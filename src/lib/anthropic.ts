...
**صيغة JSON لكل سطر:**
⚠️ **ملاحظة حرجة عن الأسعار:**
- الضريبة ثابتة **دائماً 15%**
- استخرج فقط السعر الأساسي بدون ضريبة (العمود الثاني)
- **لا تحاول قراءة السعر مع الضريبة** - النظام سيحسبه تلقائياً

{
  "item_name": "اسم العنصر بالضبط كما في الفاتورة",
  "quantity": الكمية (رقم فقط من العمود الثالث),
  "unit_price": السعر الأساسي بدون ضريبة فقط (رقم من العمود الثاني),
  "line_total": quantity × unit_price (احسبه بدقة بدون ضريبة),
...
٣. **دقة الأسعار (حرج جداً!):**
   - استخرج **فقط** السعر الأساسي من العمود الثاني (بدون ضريبة)
   - لا تقرأ العمود الأول - النظام سيحسب الضريبة 15% تلقائياً
   - الأسعار الكسرية بدقة كاملة: 13.90، 5.21، 8.69، 12.17، 0.566، 0.578، إلخ
   - أي خطأ في قراءة السعر الأساسي = خطأ في المجموع الكلي
   - قاعدة ذهبية: السعر الأساسي يجب يكون أصغر من السعر مع الضريبة بـ ~13% دائماً
