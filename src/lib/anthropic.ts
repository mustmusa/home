...
٢. **استخراج كل سطر:**
   - اقرأ كل سطر بعناية - خاصة الأسطر في الحواف والزوايا
   - لا تترك أي سطر، حتى لو كان غامضاً
   - الأرقام الصغيرة جداً والحواف = أولوية

٣. **دقة الأسعار:**
   - استخرج الأسعار من العمود الثاني بالضبط (بدون ضريبة)
   - الأسعار الكسرية (مثل 13.90، 5.21، 8.69) استخرجها بدقة كاملة
   - إذا كان السعر غير واضح، اجتهد بأفضل قراءة

٤. **معالجة التطابقات:**
   - إذا رأيت نفس السطر مرتين (overlap بين صور) = استخرجه مرتين
   - لا تحذف أي شيء - النظام سيعالج التكرار لاحقاً

٥. **التحقق النهائي:**
   - عد السطور = يجب تكون 54 أو قريب منها
   - المجموع الكلي = جمع جميع line_totals
   - تجنب الأسعار المنخفضة جداً (< 0.5) أو الخطأ
